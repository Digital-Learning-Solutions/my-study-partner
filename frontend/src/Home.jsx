      ...
      <section className="bg-blue-600 text-white">
        <div className="container mx-auto px-6 py-20 md:py-28 text-center">
          ...
          <div className="mt-8">
            <Link
              to="/register"
              className="bg-white text-blue-600 font-bold py-3 px-8 rounded-lg shadow-lg hover:bg-blue-50 transition-transform transform hover:scale-105 inline-block"
            >
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="bg-white p-3 rounded-full shadow-lg hover:bg-slate-100 transition text-slate-500 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <svg
                  className="w-6 h-6"
                  fill="none"
          ...
          <div className="relative overflow-hidden">
            ...
            >
              ...
              <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full">
                  <a href="#">
                    <img
                      src="https://placehold.co/600x400/3b82f6/ffffff?text=Course+1"
                      alt="Course 1"
                      className="w-full h-40 object-cover"
                    />
                  </a>
                  <div className="p-4 flex flex-col flex-grow">
                    <h3 className="font-bold text-lg">ChatGPT Masterclass</h3>
                    <p className="text-sm text-slate-500">Henry Habib</p>
                    <div className="mt-auto pt-2">
                      <p className="font-bold">₹629</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full">
                  <a href="#">
                    <img
                      src="https://placehold.co/600x400/10b981/ffffff?text=Course+2"
                      alt="Course 2"
                      className="w-full h-40 object-cover"
                    />
                  </a>
                  <div className="p-4 flex flex-col flex-grow">
                    <h3 className="font-bold text-lg">ChatGPT & AI Tools</h3>
                    <p className="text-sm text-slate-500">Todd McLeod</p>
                    <div className="mt-auto pt-2">
              ...
              <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full">
                  <a href="#">
                    <img
                      src="https://placehold.co/600x400/8b5cf6/ffffff?text=Course+3"
                      alt="Course 3"
                      className="w-full h-40 object-cover"
                    />
                  </a>
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <p className="text-sm text-slate-500">Jun Wu</p>
                    <div className="mt-auto pt-2">
                      <p className="font-bold">₹629</p>
                    </div>
                  </div>
              ...
              <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full">
                  <a href="#">
                    <img
                      src="https://placehold.co/600x400/f59e0b/ffffff?text=Course+4"
                      alt="Course 4"
                      className="w-full h-40 object-cover"
                    />
                  </a>
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <p className="text-sm text-slate-500">Ardit Sulce</p>
                    <div className="mt-auto pt-2">
              ...
              <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full">
                  <a href="#">
                    <img
                      src="https://placehold.co/600x400/ef4444/ffffff?text=Course+5"
                      alt="Course 5"
                      className="w-full h-40 object-cover"
                    />
                  </a>
              ...
              <div className="flex-shrink-0 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 p-4">
                <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 hover:-translate-y-2 flex flex-col h-full">
                  <a href="#">
                    <img
                      src="https://placehold.co/600x400/3b82f6/ffffff?text=Course+6"
                      alt="Course 6"
                      className="w-full h-40 object-cover"
                    />
                  </a>
                  <div className="p-4 flex flex-col flex-grow">
                    <h3 className="font-bold text-lg">React for Beginners</h3>
        ...
        <div className="w-full overflow-hidden">
          <div className="flex animate-marquee">
            <div className="flex w-max items-center">
              <img
                src="https://placehold.co/200x100/e2e8f0/a0aec0?text=Sponsor+A"
                alt="Sponsor A"
                className="mx-8 h-10 grayscale opacity-75"
              />
              <img
                src="https://placehold.co/200x100/e2e8f0/a0aec0?text=Sponsor+B"
                alt="Sponsor B"
                className="mx-8 h-10 grayscale opacity-75"
              />
              <img
                src="https://placehold.co/200x100/e2e8f0/a0aec0?text=Sponsor+C"
                alt="Sponsor C"
                className="mx-8 h-10 grayscale opacity-75"
              />
              <img
                src="https://placehold.co/200x100/e2e8f0/a0aec0?text=Sponsor+D"
                alt="Sponsor D"
                className="mx-8 h-10 grayscale opacity-75"
              />
              <img
                src="https://placehold.co/200x100/e2e8f0/a0aec0?text=Sponsor+E"
                alt="Sponsor E"
                className="mx-8 h-10 grayscale opacity-75"
              />
              <img
                src="https://placehold.co/200x100/e2e8f0/a0aec0?text=Sponsor+F"
                alt="Sponsor F"
                className="mx-8 h-10 grayscale opacity-75"
              />
