            ...
            >
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <article
                  key={i}
                  data-card
                  className="snap-start shrink-0 w-[85%] sm:w-[60%] md:w-[45%] lg:w-[30%]"
                >
        ...
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <FeatureCard
              ...
              description="Instant help via intelligent chat and voice interface."
            />
            <FeatureCard
              icon={Zap}
              title="Adaptive Quizzes"
              description="Quizzes that adjust to your personal skill level."
            />
            <FeatureCard
              icon={BookOpen}
              title="Personalized Content"
              description="Study materials and recommendations tailored to you."
            />
            <FeatureCard
              icon={BarChart2}
              title="Progress Tracking"
              description="Visualize your learning with clear dashboards."
            />
          </div>
        </div>
      </section>
