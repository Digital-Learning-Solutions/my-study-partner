...
export default function Dashboard() {
  ...
  const subjectStats = useMemo(() => {
    ...
    allCourses.forEach((ec) => {
      ...
      const category = ec.course?.courseType || "General";
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6 text-slate-900 dark:text-slate-100">
                ...
                (_, idx) => {
                  ...
                  return (
                    <div
                      ...
                      } ${isToday ? "ring-2 ring-orange-300 ring-inset" : ""}`}
                    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <button
          onClick={() =>
            setShowCoursesList(showCoursesList === "all" ? "none" : "all")
          }
        ...
        >
          ...
          <div className="text-sm text-slate-500 mt-1">
            {courseStats.completedCourses} completed,{" "}
            {courseStats.ongoingCourses} ongoing
          </div>
        </button>
        ...
        <button
          onClick={() =>
            setShowCoursesList(
              showCoursesList === "completed" ? "none" : "completed"
            )
          }
          className="text-left rounded-2xl p-5 border border-white/10 bg-white/6 dark:bg-slate-900/40 backdrop-blur-md shadow-sm hover:shadow-lg hover:scale-[1.02] transition cursor-pointer"
        >
              ...
              <div className="relative w-24 h-24">
                <svg className="w-full h-full transform -rotate-90">
                  ...
                  <circle
                    ...
                    strokeWidth="3"
                    strokeDasharray={`${
                      (courseStats.ongoingCourses / courseStats.totalEnrolled) *
                        264 || 0
                    } 264`}
                    strokeLinecap="round"
                  />
                ...
                <svg className="w-full h-full transform -rotate-90">
                  ...
                  <circle
                    ...
                    strokeDasharray={`${Math.min(
                      (safeQuiz.totalQuizzesPlayed / 20) * 264,
                      264
                    )} 264`}
                    strokeLinecap="round"
                  />
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {topicInterestStats.slice(0, 8).map((topic, idx) => {
                const barWidth = topic.avgProgress;
                  ...
                  <div key={topic.name} className="group">
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex-1 flex items-center gap-2">
                        ...
                        <h4 className="font-semibold text-slate-200 capitalize flex-1">
                          {topic.name}
                        </h4>
                    ...
                    <div className="relative h-8 bg-slate-700/20 rounded-lg overflow-hidden border border-slate-600/30">
                      ...
                      <div className="absolute inset-0 flex items-center px-3 justify-between text-sm font-semibold">
                        ...
                        {/* <span
                          className={`text-white ${color.text.replace(
                            "text-",
                            "drop-shadow-lg"
                          )} font-bold`}
                        >
            ...
            <div className="mt-6 pt-6 border-t border-slate-700/30 grid grid-cols-2 md:grid-cols-4 gap-3">
              ...
              <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 rounded-lg p-3">
                ...
                <p className="text-2xl font-bold text-purple-400 mt-1">
                  {Math.round(
                    topicInterestStats.reduce((sum, t) => sum + t.count, 0) /
                      topicInterestStats.length
                  )}
                </p>
              </div>
            ...
            {safeQuiz.byCourse.map((course, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-pink-500 opacity-0 group-hover:opacity-10 transition blur-xl" />
        ...
        <div className="space-y-3">
          {safeDiscussions && safeDiscussions.length > 0 ? (
            ...
            <div className="text-slate-400 text-sm py-4 text-center">
              No questions created yet. Start a discussion to share your
              knowledge!
            </div>
          )}
        </div>
